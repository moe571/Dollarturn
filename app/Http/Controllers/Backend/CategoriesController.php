...
class CategoriesController extends BackendController
{
    ...
    public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect('/auth/admin/panel/backend/categories')->with('message', 'New category has been successfully added !');
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
      ...
      return redirect('/auth/admin/panel/backend/categories')->with('message', 'Category has been successfully updated !');
    ...
    public function destroy(Requests\CategoryDestroyRequest $request, $id)
    {
      ...
      $category = Category::findOrFail($id);
      $category->delete();
      return redirect('/auth/admin/panel/backend/categories')->with('message', 'Category has been successfully deleted !');
    }
}
