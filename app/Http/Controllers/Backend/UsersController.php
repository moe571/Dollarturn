...
class UsersController extends BackendController
{
    ...
    public function update(Requests\UserUpdateRequest $request, $id)
    {
      ...
      return redirect('/backend/users')->with('message', 'User has been successfully updated !');
    }
    ...
    public function destroy(Requests\UserDestroyRequest $request, $id)
    {
      ...
      return redirect('/backend/users')->with('message', 'User has been successfully deleted !');
