...
class BlogController extends BackendController
{
    ...
    public function store(Requests\PostRequest $request)
    {
      ...
      return redirect('/auth/admin/panel/backend/blog')->with('message', 'Your post was created successfully!');
    ...
    public function update(Requests\PostRequest $request, $id)
    {
     ...
     return redirect('/auth/admin/panel/backend/blog')->with('message', 'Your post was updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/auth/admin/panel/backend/blog')->with('trash-message', ['Your post was moved to Trash', $id]);
    }
...

    {
      ...
      return redirect('/auth/admin/panel/backend/blog?status=trash')->with('message', 'Your post was permanently deleted !');
    }
    ...
    public function restore($id)
    {
      ...
      return redirect('/auth/admin/panel/backend/blog')->back()->with('message', 'Your post was moved from Trash !');
    }
