...
class Post extends Model
{
	...
	protected $fillable = ['title', 'slug','en_slug','es_slug','ar_slug','meta_description','lang', 'excerpt', 'body', 'published_at', 'category_id','category_slug','image'];
